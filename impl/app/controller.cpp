...
namespace bm::app
{
	...
	//bool DebugCameraController::onMouseClick(MouseButtonPress& e)
	//{
	...
	//bool DebugCameraController::onMouseRelease(MouseButtonRelease& e)
	//{
	//	if (Input::Mouse::RIGHT != e.getKey())
	//		return false;
	...
	//bool DebugCameraController::onScroll(MouseScroll& e)
	//{
	//	if (not m_camera)
	//		return false;
	...
	//bool DebugCameraController::onMouseMove(MouseMove& e)
	//{
	//	if (not m_camera)
	//		return false;
